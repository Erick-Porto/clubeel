...
// 1. Extrair URLs para constantes para melhor legibilidade
...
export default function MapLocation(){
    // 2. Construir a URL do iframe usando a variável de ambiente
    ...
    return(
        <div className={styles.mapLocation}>
            ...
            <iframe
                ...
                frameBorder="0"
                src={mapEmbedUrl}
                title="Mapa da localização do Clube dos Funcionários" // 3. Adicionar título para acessibilidade
                loading="lazy" // 4. Adicionar lazy loading para performance
            ></iframe>
        </div>
    )
}